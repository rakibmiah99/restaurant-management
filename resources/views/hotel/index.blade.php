...
<x-main-layout :title="__('menu.hotel')">
    <div class="p-4">
        <div class="card">
           <x-card-header :can-create="\App\Helper::HasPermissionMenu('hotel', 'create')" :url="route('hotel.create')" :name="__('page.hotels')" :url-name="__('page.create')"/>
            <div class="mt-3">
                <x-filter-data :can-export="\App\Helper::HasPermissionMenu('hotel', 'export')" export-url="hotel.export" translate-from="db.hotel" :columns="$columns"/>
