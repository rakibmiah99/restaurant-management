...
<x-main-layout>
    <div class="p-4">
        <div class="card">
           <x-card-header :url="route('role.create')" :name="__('page.roles')" :url-name="__('page.create')"/>
            <div class="mt-3">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                <a data-bs-toggle="modal" data-bs-target="#viewModal" class="dropdown-item view-btn" href="javascript:void(0);" url="{{route('role.show', $item->id)}}"><i class='bx bx-low-vision'></i>{{__('page.view')}}</a>
